...
trait UserAttribute {
    ...
    public function getPictureAttribute() {
        return app('gravatar')->get($this->email, ['size' => 50]);
    }
    ...
    public function getChangePasswordButtonAttribute() {
        if (app('access')->can('change-user-password'))
    ...
    public function getStatusButtonAttribute() {
        switch($this->status) {
            case 0:
                if (app('access')->can('reactivate-users'))
            ...
            case 1:
                ...
                if (app('access')->can('deactivate-users'))
    ...
    public function getConfirmedButtonAttribute() {
        if (! $this->confirmed)
            if (app('access')->can('resend-user-confirmation-email'))
    ...
    public function getDeleteButtonAttribute() {
        if (app('access')->can('delete-users'))
