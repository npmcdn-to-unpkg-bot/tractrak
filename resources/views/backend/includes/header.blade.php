                ...
                <ul class="nav navbar-nav">
                  ...
                  <li class="dropdown user user-menu">
                    ...
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                      ...
                      <img src="{!! app('access')->user()->picture !!}" class="user-image" alt="User Image"/>
                      <!-- hidden-xs hides the username on small devices so only the image appears. -->
                      <span class="hidden-xs">{{ app('access')->user()->name }}</span>
                    </a>
                    <ul class="dropdown-menu">
                      ...
                      <li class="user-header">
                        <img src="{!! app('access')->user()->picture !!}" class="img-circle" alt="User Image" />
                        <p>
                          {{ app('access')->user()->name }} - {{ trans('roles.web_developer') }}
